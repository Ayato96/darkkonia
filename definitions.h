...
#define STATUS_SERVER_NAME "DarkKonia New Age"
#define STATUS_SERVER_VERSION "30.7"
#define STATUS_SERVER_CODENAME "FANTASY"
#define STATUS_SERVER_PROTOCOL "8.54"

#define VERSION_CHECK "http://darkkonia.sytes.net/version.xml"
