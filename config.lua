-- The Forgotten Server Config
	...
	maxPlayers = 100
	motd = "Welcome to the DarkKonia New Age Server - Codename: FANTASY VI (Alpha 1)"
	displayOnOrOffAtCharlist = false
	onePlayerOnlinePerAccount = true
	allowClones = false
	serverName = "DARKKONIA"
	loginMessage = "Welcome to the DarkKonia New Age Server - Codename: FANTASY VI (Alpha 1)"
	statusTimeout = 1000
	...
	niceLevel = 5
	coresUsed = "-1" -- ("0, 1, 2, 3") -- For QuadCore
